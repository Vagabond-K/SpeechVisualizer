...
namespace SpeechVisualizer
{
    ...
    {
        public const int NUM_IMAGE_COLS = Shared.CameraWidth;
        public const int NUM_IMAGE_ROWS = Shared.CameraHeight;
        ...
        private FrameGenerator _generator;

        public MediaStream(MediaSource source, uint index, int port)
        {
            _generator = new FrameGenerator(port);
            try
            {
